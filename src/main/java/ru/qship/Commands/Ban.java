        ...
        if (commandSender.isOp()) {
            if (arg.length > 0) {
                ...
                if (main.ids.get(inputid) != null) {
                    ...
                    p.kickPlayer("Вы были забанены по причине: " + arg[1]);

                    commandSender.sendMessage(ChatColor.translateAlternateColorCodes('&', "&7CONSOLE: &fИгрок с &7id <" + arg[0] + "> &fуспешно забанен"));
                ...
                commandSender.sendMessage(ChatColor.translateAlternateColorCodes('&', "&7CONSOLE: usage: &f/banid id reason"));
